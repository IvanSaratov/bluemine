    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].WikiFatherID == 0) {
            if (!nodeExists(data[i].WikiIDStr)) {
                ...
                html = '<div class="wiki_art" id="' + data[i].WikiIDStr + '"><div class="item"><span id="icowikihide"></span><a href="/wiki/' + data[i].WikiIDStr + '">' + data[i].WikiName + '</a></div></div>'
                $(wrap).append(html);
            ...
            if (!nodeExists(data[i].WikiIDStr)) {
                ...
                html = '<div class="wiki_art" id="' + data[i].WikiIDStr + '"><div class="nested_item"><span id="icowikihide"></span><a href="/wiki/' + data[i].WikiIDStr + '">' + data[i].WikiName + '</a></div></div>'
                $(wrap).append(html);
